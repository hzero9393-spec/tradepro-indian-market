...
// On Vercel, we ALWAYS use PostgreSQL if DATABASE_URL is set
// The schema selection is based on DATABASE_URL prefix
...
if (isPostgres) {
  ...
  if (isVercel) {
    ...
    console.log('⚠️ WARNING: Running on Vercel but no PostgreSQL DATABASE_URL found!');
